...
const VERIFY_EMAIL_ENDPOINT = `${AUTH_BASE}/verify`;
...
export { SIGNUP_ENDPOINT, LOGIN_ENDPOINT, VERIFY_EMAIL_ENDPOINT, FORGOT_PASSWORD, VERIFY_RESET_OTP_ENDPOINT, RESET_PASSWORD_ENDPOINT };
